...
**Обновлено:** 2026-06-27 · **В проде:** `1.5.35` 🚀 · **Tier-2 6/6 зарелизено** (#1 LSP-нав, #6 file-rules, #4 bash-allowlist, #2 microcompact, #5 browser+MP4-Proof, #3 ветвление сессий) · **Тесты:** 1580 зелёных · **Ветка:** main · **Хвост:** T1.2 деферн; UI-биты (#3 дерево, #5 browser-цикл) — 1 живой клик

...
**Обновлено:** 2026-06-19 (ночь) · **В проде:** `1.5.17` · **Тесты:** ~1200 зелёных · **Ветка:** main
...
**Живой проверки ждут (зона Ильи / запущенный app):** retry-цикл A на реальном verify-провале · профиль C (авто-сбор/онбординг) · весь E.

...
**Обновлено:** 2026-06-25 · **В проде:** `1.5.34` 🚀 · **Тесты:** ~1537 зелёных (полный прогон) · **Ветка:** main · **Хвост:** Rust/Go LSP у Pavel (env: `rustup component add rust-analyzer` + установить gopls); T1.2 деферн (дизайн в роудмапе)

...
**Обновлено:** 2026-06-30 · **В проде:** `1.5.43` 🚀 · **Конкурентная ось 3 — ТОП-5 (1.5.42) + deferred I/F/H (1.5.43) ЗАРЕЛИЗЕНЫ** · **Тесты:** ~1720 зелёных · **Ветка:** main · **Хвост:** чужие зоны (Gateway→Codex, дизайн, скиллы→Павел); inbound TG-пульт — за go Павла

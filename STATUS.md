...
**Обновлено:** 2026-06-29 · **В проде:** `1.5.42` 🚀 · **Конкурентная ось 3 — ТОП-5 ЗАРЕЛИЗЕН** (5/5) поверх дорожной карты vs Hermes/OpenClaw (8/8) · **Тесты:** ~1700 зелёных · **Ветка:** main · **Хвост:** чужие зоны (Gateway→Codex, дизайн, скиллы→Павел); inbound TG-пульт — за go Павла

...
**Обновлено:** 2026-06-28 · **В проде:** `1.5.38` 🚀 · **OpenClaw-усреднение #1–#5 ЗАРЕЛИЗЕНО** (5/5) · **Тесты:** ~1620 зелёных · **Ветка:** main · **Хвост:** UI-биты — 1 живой клик; чужие зоны (Gateway→Codex, дизайн, скиллы→Павел); inbound TG-пульт — за go Павла

...
**Обновлено:** 2026-06-29 · **В проде:** `1.5.40` 🚀 · **Дорожная карта vs Hermes/OpenClaw — ТОП-3 + next-wave ЗАРЕЛИЗЕНЫ** (7/7) · **Тесты:** ~1660 зелёных · **Ветка:** main · **Хвост:** живые connector-аудиты в NL-cron (нужна op-level read/write классификация); чужие зоны (Gateway→Codex, дизайн, скиллы→Павел); inbound TG-пульт — за go Павла

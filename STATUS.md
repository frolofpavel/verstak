...
**Обновлено:** 2026-06-26 · **В проде:** `1.5.34` 🚀 · **В main (не зарелизено):** Tier-2 5/6 — #1 LSP-нав, #6 file-rules, #4 bash-allowlist, #2 microcompact, #5 browser-проверка+MP4-Proof · **Тесты:** ~1595 зелёных · **Ветка:** main · **Хвост:** #3 дерево сессий деферн (L, UI); T1.2 деферн

...
**Обновлено:** 2026-06-29 · **В проде:** `1.5.41` 🚀 · **Дорожная карта vs Hermes/OpenClaw — ТОП-3 + next-wave + follow-up ЗАРЕЛИЗЕНЫ** (8/8) · **Тесты:** ~1670 зелёных · **Ветка:** main · **Хвост:** чужие зоны (Gateway→Codex, дизайн, скиллы→Павел); inbound TG-пульт — за go Павла

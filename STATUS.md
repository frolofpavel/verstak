...
**Обновлено:** 2026-06-27 · **В проде:** `1.5.36` 🚀 · **Tier-2 6/6 + T1.2 зарелизены** · **Тесты:** ~1590 зелёных · **Ветка:** main · **Хвост:** UI-биты (#3 дерево, #5 browser-цикл) — 1 живой клик; чужие зоны (Gateway→Codex, дизайн-полиш, архитектура скиллов→Павел)

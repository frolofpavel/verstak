...
**Обновлено:** 2026-06-23 · **В проде:** `1.5.31` · **Тесты:** ~1465 зелёных (полный прогон) · **Ветка:** main
...
| 3 | **Решение по архитектуре скиллов** | Варианты: (1) аудит 50+ скиллов (живо/мёртво/схлопнуть); (2) pre-commit хук Verstak (блок коммита при провале type/тестов); (3) тонкий `/verstak`-скилл (авто-STATUS + журнал + реестр). Выбор Павла | Павел |

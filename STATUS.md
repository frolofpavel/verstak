...
- ⬜ **B: роутинг tool-слоя на ssh** (read/write/run/list когда kind=ssh) — твоя цель (сайт). Объём L, **правит прод-сервер → нужна живая проверка**
- ⬜ B: undo удалённых файлов · UI «Добавить проект» (Илья)

...
**Обновлено:** 2026-06-25 · **В проде:** `1.5.33` 🚀 · **Тесты:** ~1531 зелёных (полный прогон) · **Ветка:** main · **Хвост:** live-проверка не-TS LSP (с pyright) + PTC (при ptc_enabled); T1.2 деферн (дизайн в роудмапе)

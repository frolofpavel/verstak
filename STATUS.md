...
**Обновлено:** 2026-06-28 · **В проде:** `1.5.39` 🚀 · **Дорожная карта vs Hermes/OpenClaw ТОП-3 ЗАРЕЛИЗЕНО** (3/3) · **Тесты:** ~1640 зелёных · **Ветка:** main · **Хвост:** UI-биты — 1 живой клик; чужие зоны (Gateway→Codex, дизайн, скиллы→Павел); inbound TG-пульт — за go Павла

...
**Обновлено:** 2026-06-27 · **В проде:** `1.5.36` 🚀 · **В main (не зарелизено):** OpenClaw-усреднение #1+#2+#3+#4 (4 фичи) · **Тесты:** ~1615 зелёных · **Ветка:** main · **Хвост:** UI-биты (модалки/кнопки) — 1 живой клик; чужие зоны (Gateway→Codex, дизайн, скиллы→Павел)

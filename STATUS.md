...
**Обновлено:** 2026-06-28 · **В проде:** `1.5.37` 🚀 · **OpenClaw-усреднение #1–#4 зарелизено** (+#5 merge-ядро в main) · **Тесты:** ~1615 зелёных · **Ветка:** main · **Хвост:** #5 полный lifecycle (L, UI) — отдельной сессией; UI-биты — 1 живой клик; чужие зоны (Gateway→Codex, дизайн, скиллы→Павел)

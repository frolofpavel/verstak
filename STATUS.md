...
**Обновлено:** 2026-06-23 · **В проде:** `1.5.28` · **Тесты:** 1405 зелёных · **Ветка:** main
...
| B | **21 medium/low находка ревью** | Сохранены только critical/high (пофикшены→1.5.28). Мелочи (Verstak: ai.ts stop-во-время-retry, supervisor-note мёртвый, cross-verify на max-turns; Gateway: cache-race, auth_reset email_verified bypass, и т.д.) — только в логе workflow `wf_c485e0e0`. Решить: чинить/бэклог/игнор | Claude/Codex |

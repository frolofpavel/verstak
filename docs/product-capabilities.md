...
## Коннекторы (31)
**База (10):** GitHub · Google Sheets · Telegram · SSH (с denylist + classifyCommand) · Битрикс24 (read-only) · Я.Директ · Я.Диск · 1С OData · HTTP API · соцсети-публикация.
**RU-стек (21):** DaData · Контур.Фокус · Я.Метрика/Вебмастер/Wordstat/Трекер · GA4 · Ozon Seller/Performance · Wildberries · MPSTATS · Avito · amoCRM · МойСклад · ЮКасса (чтение) · SendPulse · UniSender · VK · Jira · Trello · Notion.
Все read-only, свой код поверх официальных API, 30-секундный таймаут + scanText на выводе.

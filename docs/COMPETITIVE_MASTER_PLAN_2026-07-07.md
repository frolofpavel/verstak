...
### Дополнение 2026-07-07: PROC-01/PROC-02/PROC-03/PROC-04/PROC-05/PROC-07 закрыты
...
- **Ограничение**: `PROC-06` full OS anti-orphan smoke и `PROC-08` UI timeline polish ещё не закрыты.

...
// 10.08 (пакет 2.5.0): A1 5134 → 5140, A2 5140 → 5143 — каждый раз ИЗМЕРЕНО
// прогоном слитого дерева (--maxWorkers=4; A2: 5128 passed + 15 skipped = 5143).
const EXPECTED_TOTAL_TESTS = 5143

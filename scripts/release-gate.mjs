...
// 01.08, композер (VSK-PRODUCT-A1): .xlsx в accept + разворачивание xlsx-вложений
// (exceljs) — +7 пинов → 4536 = 4522 passed + 14 skipped (эталоны до: 4529, 4527, 4515).
const EXPECTED_TOTAL_TESTS = 4536

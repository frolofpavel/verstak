...
// 13.08 P3 кусок 2, блокер SPA-выдачи (иконочный контрол без семантики попадает в
// снимок) → 5389 (измерено, --maxWorkers=4; 5374 passed + 15 skipped).
const EXPECTED_TOTAL_TESTS = 5389

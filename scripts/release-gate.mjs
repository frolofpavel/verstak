...
// 01.08, композер (VSK-PRODUCT-A1): «Папка с документами» (нативный диалог → проект,
// one-shot вооружение код-сводки) + кнопка/подпись B1 — +8 пинов → 4544 = 4530 passed
// + 14 skipped (эталоны до: 4536 [xlsx], 4529, 4527, 4515).
const EXPECTED_TOTAL_TESTS = 4544

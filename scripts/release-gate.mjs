...
// --maxWorkers=4`, 0 падений, +19 пинов моста и состава argv). Та же оговорка,
// что и у 5441: замер ОДНОЙ линии; при вливании нескольких — перемерить на слитом.
const EXPECTED_TOTAL_TESTS = 5460

...
// 01.08, браузер (VSK-BROWSER-B1 этап 1): структурный снимок с нумерацией +
// клик-по-номеру (протухание номеров) + SEC-CMD-06 на новом пути — +9 пинов → 4553
// = 4539 passed + 14 skipped (эталоны до: 4544 [папка], 4536, 4529, 4527, 4515).
const EXPECTED_TOTAL_TESTS = 4553

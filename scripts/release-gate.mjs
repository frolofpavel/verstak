...
// 29.07, после пинов пути записи и секретов (SEC-SECRET-01/02): 4348 = 4334
// passed + 14 skipped (предыдущие: 4321, 4310, 4290, 4285, 4278, 4274, 4267,
// 4256, 4237, 4212).
const EXPECTED_TOTAL_TESTS = 4348

...
// 01.08, проводка код-сводки материалов (VSK-PRODUCT-A1 3b ч.2/2): main-сторона
// 4527, рендер +2 пина (materials-read из seed и ПОСЛЕ done) → 4529 = 4515 passed
// + 14 skipped (эталоны до: 4527, 4515).
const EXPECTED_TOTAL_TESTS = 4529

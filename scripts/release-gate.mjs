...
// 10.08 (пакет 2.5.0, A1): 5134 → 5140 — ИЗМЕРЕНО прогоном слитого дерева
// (--maxWorkers=4, 588 files passed, 5125 passed + 15 skipped = 5140).
const EXPECTED_TOTAL_TESTS = 5140

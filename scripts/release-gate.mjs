...
// 01.08, блок 4 (пункты «СКОРО»): сняты флаги Расписание/Агенты/Карта/Мозг после
// mount-пинов (панель ОТКРЫВАЕТСЯ И ДЕЛАЕТ РАБОТУ, а не «кнопка кликается») — +5
// пинов → 4558 = 4544 passed + 14 skipped (эталоны до: 4553 [браузер], 4544, 4536, 4529, 4527, 4515).
const EXPECTED_TOTAL_TESTS = 4558

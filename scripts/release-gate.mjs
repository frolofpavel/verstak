...
// 10.08 (пакет 2.5.0): A1 5134 → 5140, A2 → 5143, B1 → 5148 — каждый раз
// ИЗМЕРЕНО прогоном слитого дерева (--maxWorkers=4; B1: 5133 passed + 15 skipped).
const EXPECTED_TOTAL_TESTS = 5148

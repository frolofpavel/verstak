...
- **Прогон, собравший МЕНЬШЕ тестов, чем эталон, — не вердикт, а оборванный
  запуск.** Эталон: `numTotalTests` = **4912** (08.08, слияние четырёх
  параллельных линий: 4907 −3 +8 — измерено).
  **Эталон ИЗМЕРЯЕТСЯ на слитом дереве, а НЕ складывается из приростов линий.**
  ...
  вычисления.
  До 4912 — 4907, 4904, 4888, 4886, 4881; по облачной линии 4779, 4751 (graceful shutdown: host.close() ждёт живые

export const en = {
  ...
  settings: {
    ...
    browserSetup: {
      ...
      connectedHint: 'Ready. Click the Verstak icon on the target page and give the command in a regular chat or the browser panel.',
      ...
      extensionReady: 'Connected',
      extensionWaiting: 'Waiting to be opened',
    },

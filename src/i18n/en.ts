export const en = {
  ...
  rail: {
    ...
    openExistingClientHint: 'Pick a folder on disk, as before',
    createNameLabel: 'Client name',
    createNamePlaceholder: 'e.g. Acme Corp',
    createNameRequired: 'Enter a client name',
    ...
    createPreviewFallback: 'New client',
    createSubmit: 'Create',
    creating: 'Creating…',
    back: 'Back',
    close: 'Close',
  ...
  projectSettings: {
    ...
    removeFromListDesc: 'Hides the client in Verstak. Folder and chat history on disk stay.',
    ...
    deleteWithDataDesc: 'Client folder, chats, tasks and journal in Verstak — irreversible.',
    deleteConfirmTitle: 'Delete without recovery?',
    deleteConfirmBody: 'This deletes the client folder and all Verstak data for «{name}» (chats, tasks, journal, memory). Cannot be undone.',

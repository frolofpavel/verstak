export const en = {
  ...
  settings: {
    ...
    computerUse: {
      title: 'Work in one selected Windows window',
      description: 'Select one window. Each explicit Computer Use command receives time-limited access to that exact target only.',
      unsupported: 'Supported on Windows only',
      unavailable: 'Local executor is unavailable',
      ready: 'Ready to select a window',
      bound: 'Window selected',
      readyHint: 'Only regular available windows are listed. Elevated and protected surfaces are blocked.',
      boundHint: 'The window is selected. After sending the command, switch to that window and do not use the mouse or keyboard until it finishes. A target change invalidates the action.',

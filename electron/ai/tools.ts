...
Возвращает количество применённых блоков. Требует подтверждения пользователя как обычный write — diff отображается в том же модальном окне.`,
  ...
  {
    name: 'create_plan',
    description: 'Создать структурированный план многошаговой задачи. Вызывай когда задача многошаговая (3+ шагов) ИЛИ это многошаговое исследование — аудит, разбор, сводка из нескольких файлов/страниц/источников, — даже если работа только читает. Читающий план НЕ останавливает работу (он информационный); согласования ждёт только план с записью или ответственным действием. План отобразится во вкладке Plan; пользователь сможет выполнять шаги по одному.',
    parameters: {
      type: 'object',
      properties: {
